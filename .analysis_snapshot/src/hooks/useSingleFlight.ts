...
type FlightStatus<TArgs extends Array<any>, TResult> = {
    inFlight: boolean;
    upNext: {
 ...
 */
export default function useSingleFlight<TArgs extends Array<any>, TResult>(
    fn: (...args: TArgs) => Promise<TResult>
): (...args: TArgs) => Promise<TResult> {
    const flightStatus = useRef<FlightStatus<TArgs, TResult>>({
        inFlight: false,
        upNext: null,
    });
